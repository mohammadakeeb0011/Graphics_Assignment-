...
void drawTransformedRectangle(int x1, int y1, int x2, int y2, float sx, float sy, float angle, int tx, int ty) {
...
int main() {
    ...
    setcolor(YELLOW);
    drawTransformedRectangle(x1, y1, x2, y2, sx, sy, angle, tx, ty);
